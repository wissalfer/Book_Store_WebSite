...
$successMessage="";
    ...
    if ($_SERVER['REQUEST_METHOD']=='GET'){
        ...
        $id=$_GET["id"];
        $sql="SELECT (BookID,BookTitle, ISBN, Price, Author,Type,Image) FROM book WHERE BookID=$id";
        $res=$pdo->query($sql);
        $row=$res->fetch_assoc();
        ...
        do{
            ...
            $sql = "UPDATE book"." SET BookID = '$BookID', BookTitle = '$BookTitle', 
            ISBN = '$ISBN',Price = '$Price',Author = '$Author', 
            Type = '$Type', Image='$Image'"." WHERE BookID=$id";
            $res= $pdo->query($sql);
