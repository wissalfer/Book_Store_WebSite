...
<header>
<blockquote>
	<img src="image/book_logo3.png">
	<input class="hi" style="float: right; margin: 2%;background-color: rgb(104, 138, 173);" type="button" name="cancel" value="Home" onClick="window.location='index.php';" />
</blockquote>
</header>
<?php
session_start();
