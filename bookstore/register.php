...
<header>
<blockquote>
	<a href="index.php"><img src="image/book_logo3.png"></a>
</blockquote>
</header>
<blockquote>
<div class="container">
<form method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	...
	<input class="button" type="submit" style="margin-left:255px; background-color:#d64242;" name="submitButton" value="Submit">
