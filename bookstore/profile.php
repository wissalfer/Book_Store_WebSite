                            ...
                            <div class="user-bg"> <img width="100%" alt="user" src="plugins/images/large/img1.jpg">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        ...
                                        <h4 class="text-white mt-2"><?php echo $oUserName; ?></h4>
                                        <h5 class="text-white mt-2"><?php echo $oName; ?></h5>
                                    </div>
                                </div>
                            </div>
...
<form method="post"  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
	<h1 style="color:#f5506f"><center><strong>Edit Profile</strong></center></h1>
	...
	<input  class="btn d-grid btn-danger text-white center"  style="margin-left:120px;width:80px" type="submit" name="submitButton" value="Edit">
	<input  class="btn d-grid btn-danger text-white" style="margin-left:240px;width:80px;margin-top:-33px" type="button" name="cancel" value="Cancel" onClick="window.location='index.php';" />
</form>
</div>
